 ...
 "cells": [
  {
   ...
   "id": "2608f59c-86fd-4d33-adeb-708d117db2f2",
   "metadata": {},
   "outputs": [
    {
     "name": "stderr",
     ...
     "text": [
      ...
      "INFO:     Started server process [21584]\n",
   ...
   "source": [
    ...
    "\n",
    "# Define class labels\n",
    "class_labels = ['squamous', 'adenocarcinoma', ' benign ']\n",
    "\n",
    ...
    "    config = Config(app, host=\"0.0.0.0\", port=8003)\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": None,
   "id": "fec3c142-8fb8-4a01-8948-db255dc91505",
   "metadata": {},
   "outputs": [],
   "source": []
  }
